    ...
    return (
      <Box
        sx={{
          minHeight: "100vh",
          background:
            "linear-gradient(135deg, #e8f4f8 0%, #f0f8ff 50%, #fff5e6 100%)",
          position: "relative",
          py: { xs: 2, sm: 3, md: 4 },
          px: { xs: 1, sm: 2 },
          "&::before": {
      ...
      >
        <Container
          maxWidth="lg"
          sx={{ position: "relative", zIndex: 1, px: { xs: 0, sm: 2 } }}
        >
          <QuizFlow />
        </Container>
      </Box>
  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #005fa3 0%, #ff9800 50%, #ff6f00 100%)",
        position: "relative",
        display: "flex",
        alignItems: "center",
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              sx={{
                ...
                background: "linear-gradient(135deg, #005fa3 0%, #ff9800 100%)",
                boxShadow:
                  "0 8px 25px rgba(0, 95, 163, 0.4), 0 0 0 0 rgba(255, 152, 0, 0.4)",
                borderRadius: 3,
                textTransform: "none",
                position: "relative",
                overflow: "hidden",
                ...
                "&:hover": {
                  background:
                    "linear-gradient(135deg, #004a82 0%, #ff6f00 100%)",
                  boxShadow:
                    "0 12px 35px rgba(0, 95, 163, 0.5), 0 0 0 4px rgba(255, 152, 0, 0.2)",
                  "&::before": {
                    left: "100%",
                  },
                },
